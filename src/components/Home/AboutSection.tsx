    ...
    <section id="sobre-mi" className="w-full max-w-6xl mx-auto py-16 md:py-24 px-4 pt-24 scroll-mt-24 relative z-10">
      <div>
        <div className="mb-12 text-center">
          ...
          <p className="text-[#232a3a] dark:text-neutral-300 max-w-2xl mx-auto font-medium text-lg text-center mb-4">
          ...
          <span className="block text-xs md:text-sm text-[#2563eb] mt-6 text-center italic">Transformo ideas en productos digitales robustos y <span className="text-[#2563eb]">escalables</span>.</span>
        </div>
        {/* ...existing code... */}
